...
const SYSTEM_PROMPT = [
  ...
  "  2. As soon as you spot a signal page that fetches successfully, record_source it as 'webpage'. This includes both flavors: list pages (/blog, /changelog, /news, /releases) AND snapshot pages (/pricing, /plans, top product/feature pages). Record incrementally — don't wait until the end.",
  ...
  "  7. When you have everything meaningful, call finish. Target ~4–8 sources for a typical SaaS competitor (1–2 list pages, /pricing, 1–2 feature pages, plus socials).",
  "",
  "Rules:",
  "  • Record incrementally, not in a batch. Every fetch_page that returns content for a plausible signal page (blog/changelog/news/releases/pricing/plans/feature landing) should be followed by record_source for that URL — same turn if possible.",
