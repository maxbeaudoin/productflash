...
async function main() {
  ...
  console.log(`Persisted digest spans ${persistedComps.size} competitor(s): ${[...persistedComps].join(', ')}`)
  console.log(`Simulated diverse selection would span ${simulatedComps.size} competitor(s): ${[...simulatedComps].join(', ')}`)
