...
Emit the full report in **exactly** this order, in **one message**, _before_ asking anything.
...
- Asking "Push?" _before_ emitting the Step 9 report. The report is the gate; the push question follows it.
